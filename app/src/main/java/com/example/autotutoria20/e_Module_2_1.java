...
public class e_Module_2_1 {
    ...
    */
    ...
    public static e_Question[] get_PostTest_Lesson2_Easy_Questions() {
        return getPostTestQuestions(post_test_lesson_2_questions_easy, post_test_lesson_2_choices_easy, post_test_lesson_2_answers_easy);
    }
    ...
    */
    ...
    public static e_Question[] get_PostTest_Lesson2_Medium_Questions() {
        return getPostTestQuestions(post_test_lesson_2_questions_medium, post_test_lesson_2_choices_medium, post_test_lesson_2_answers_medium);
    }
