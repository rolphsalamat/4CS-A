...
public class c_Lesson_freeuse_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HashMap<String, Map<String, Object>> progressiveModeData = getLessonDataForLesson(sharedPreferences, "Free Use Mode", "Lesson 1");
            ...
            for (String lessonName : sortedLessonNames) {
                ...
                for (Map.Entry<String, Object> lessonEntry : lessonData.entrySet()) {
                    ...
                    if (iteration < z_Lesson_steps.lesson_1_steps.length) {
                        ...
                        updateModuleProgressText("freeuse_lesson_1_module_" + moduleName.charAt(1), moduleValue + "/" + z_Lesson_steps.lesson_1_steps[iteration]);
