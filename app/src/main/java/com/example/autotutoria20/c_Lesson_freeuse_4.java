...
public class c_Lesson_freeuse_4 extends AppCompatActivity {
    ...
    private void updateUI(int key, int progress) {
        ...
        switch (key) {
            case 1:
                newText = progress + "/" + L_lesson_sequence.getNumberOfSteps("M1_Lesson 4");
                if (module1ProgressText != null) {
                    module1ProgressText.setText(newText);
                } else {
                    Log.e("updateUI", "TextView for module 1 not found");
                }
                if (progress >= L_lesson_sequence.getNumberOfSteps("M1_Lesson 4")) {
                    cardCompletionStatus[0] = true; // Mark card 1 as completed
                }
                break;
            case 2:
                newText = progress + "/" + L_lesson_sequence.getNumberOfSteps("M2_Lesson 4");
    ...
    private void navigateToModuleActivity(Class<?> moduleActivityClass, int cardNumber, int numberOfSteps) {
        ...
        Intent intent = new Intent(c_Lesson_freeuse_4.this, moduleActivityClass);
