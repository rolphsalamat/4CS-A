...
public class c_Lesson_freeuse_6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.c_lesson_freeuse_6);
        ...
        int numberOfStepsForCard1 = z_Lesson_steps.lesson_6_steps[0];
        int numberOfStepsForCard2 = z_Lesson_steps.lesson_6_steps[1];
        int numberOfStepsForCard3 = z_Lesson_steps.lesson_6_steps[2];
    ...
    private void updateUI(int key, int progress) {
        ...
        TextView module1ProgressText = findViewById(R.id.freeuse_lesson_1_module_6);
        TextView module2ProgressText = findViewById(R.id.freeuse_lesson_2_module_6);
        TextView module3ProgressText = findViewById(R.id.freeuse_lesson_3_module_6);
        ...
        switch (key) {
            case 1:
                newText = progress + "/" + t_LessonSequenceFromDatabase.getNumberOfSteps("M1_Lesson 6");
                if (module1ProgressText != null) {
                    module1ProgressText.setText(newText);
                } else {
                    Log.e("updateUI", "TextView for module 1 not found");
                }
                if (progress >= t_LessonSequenceFromDatabase.getNumberOfSteps("M1_Lesson 6")) {
                    cardCompletionStatus[0] = true; // Mark card 1 as completed
                }
                break;
            case 2:
                newText = progress + "/" + t_LessonSequenceFromDatabase.getNumberOfSteps("M2_Lesson 6");
                if (module2ProgressText != null) {
                    module2ProgressText.setText(newText);
                } else {
                    Log.e("updateUI", "TextView for module 2 not found");
                }
                if (progress >= t_LessonSequenceFromDatabase.getNumberOfSteps("M2_Lesson 6")) {
                    cardCompletionStatus[1] = true; // Mark card 2 as completed
                }
                break;
            case 3:
                newText = progress + "/" + t_LessonSequenceFromDatabase.getNumberOfSteps("M3_Lesson 6");
                if (module3ProgressText != null) {
                    module3ProgressText.setText(newText);
                } else {
                    Log.e("updateUI", "TextView for module 3 not found");
                }
                if (progress >= t_LessonSequenceFromDatabase.getNumberOfSteps("M3_Lesson 6")) {
                    ...
                    feedback.retrieveBKTScore("Free Use Mode", "Lesson 6");
    ...
    private void navigateToModuleActivity(Class<?> moduleActivityClass, int cardNumber, int numberOfSteps) {
        ...
        editor.putString("currentLesson", "Lesson 6");
        ...
        Intent intent = new Intent(c_Lesson_freeuse_6.this, moduleActivityClass);
...
//                Toast.makeText(c_Lesson_freeuse_6.this, "Exiting module", Toast.LENGTH_SHORT).show();
...
//                Toast.makeText(c_Lesson_freeuse_6.this, "Cancel Exit", Toast.LENGTH_SHORT).show();
