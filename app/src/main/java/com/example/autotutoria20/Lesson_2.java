...
public class Lesson_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lesson_2);
        ...
        exitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Lesson_2.this);
                builder.setTitle("Exit module?");
                builder.setMessage("Are you sure you want to exit " + lessonTopic.getText() + "?");
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(Lesson_2.this, "Exiting module", Toast.LENGTH_SHORT).show();
    ...
    private void setCardClickListener(CardView cardView, final int cardNumber) {
        cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Lesson_2.this, d_Lesson_container.class));
            }
        });
    }
