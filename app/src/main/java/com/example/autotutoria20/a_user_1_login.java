...
//        db.collection("users")
//
//                // pag yung phone nag register gumagana sya???
//                // oo nga, pag nag sign up gumagana na :)
//
//                // TANGINA BAKET?!?!?
//
//
//                // Medium Phone | "username" - ERROR
//                // Medium Phone | "Username" - Missing or Insufficient Permission
//
//                // Pixel 5 | "username" - Username does not exist
//                // Pixel 5 | "Username" - WORKING
//
//                // Pixel 8 Pro | "username" - Missing or Insufficient Permission
//                // Pixel 8 Pro | "Username" - Missing or Insufficient Permission
...
//    private void loginUser(String username, String enteredPassword) {
//
//        // DI NA KAILANGAN TOOOO
//        // Convert the username to lowercase for case-insensitive querying (if needed)
//        String lowercaseUsername = username.toLowerCase();  // This is optional based on your requirements
//
