...
public class Lesson_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lesson_3);
        ...
        exitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Lesson_3.this);
                builder.setTitle("Exit module?");
                builder.setMessage("Are you sure you want to exit " + lessonTopic.getText() + "?");
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(Lesson_3.this, "Exiting module", Toast.LENGTH_SHORT).show();
