...
public class module_5_steps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.module_5_steps);
...
//        webView.loadUrl("https://www.youtube.com/watch?v=poa_QBvtIBA");
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(module_5_steps.this, "Next!", Toast.LENGTH_SHORT).show();
            }
        });
